...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT * FROM users WHERE email = ? AND user_type = 'employer'");
    $stmt->execute([$email]);
    $user = $stmt->fetch();
...
<body class="bg-gray-100">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="register.php" class="text-gray-700 hover:text-blue-600">Register Company</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-md w-96">
            <h2 class="text-2xl font-bold mb-6 text-center">Company Login</h2>
